...
def test_api_rooms_token_invalid_signature(settings):
    """Token signed with an invalid key should be rejected."""
    settings.APPLICATION_JWT_SECRET_KEY = "devKey"
    user = UserFactory()
...
def test_api_rooms_token_invalid_alg(settings):
    """Token signed with an invalid alg should be rejected."""
    settings.APPLICATION_JWT_SECRET_KEY = "devKey"
